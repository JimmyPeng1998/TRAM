...
//    plhs[3] = mxCreateDoubleMatrix( n3*r1*r2, 1, mxREAL );
    ...
    plhs[1] = mxCreateDoubleMatrix( n2*r1*r3, 1, mxREAL );
    plhs[2] = mxCreateDoubleMatrix( n3*r1*r2, 1, mxREAL );
...
//    result3 = mxGetPr( plhs[3] );
    Aneq1 = mxGetPr( plhs[0] );
    Aneq2 = mxGetPr( plhs[1] );
    Aneq3 = mxGetPr( plhs[2] );
